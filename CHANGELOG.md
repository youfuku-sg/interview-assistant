...
- 起動時の署名付き自動アップデート確認、承認後のダウンロード・インストール・再起動を追加（Issue #39）

## [0.6.6] - 2026-09-08

### Changed

- npm / Cargo依存関係を更新し、既知の依存関係脆弱性への対応を反映（Issue #37）

## [0.6.5] - 2026-09-08

### Fixed

- ウィンドウを縦方向にリサイズした際、トップバーの文字起こし・要約・AI回答の各パネルがウィンドウ高に追従するよう修正（Issue #35）

### Changed

- 依存関係を更新し、既知のnpm依存関係脆弱性を解消（Issue #37）
